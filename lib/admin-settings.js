jQuery(document).ready(function ($) {
    ...
    $('a[href*="action=clean"]').click(function () {
        return confirm(krmosAdminL10n.confirmClean);
    });

    $('a[href*="action=upload"]').click(function () {
        return confirm(krmosAdminL10n.confirmUpload);
    });

    $('a[href*="action=sync"]').click(function () {
        return confirm(krmosAdminL10n.confirmSync);
    });

    $('a[href*="action=reset"]').click(function () {
        return confirm(krmosAdminL10n.confirmReset);
    });
});
